...
const MANAGER_TOOLS  = new Set(["close_position", "claim_fees", "swap_token", "get_position_pnl", "get_my_positions", "get_wallet_balance", "get_hive_pool_consensus", "get_hive_lesson_consensus", "get_hive_pulse"]);
const SCREENER_TOOLS = new Set(["deploy_position", "get_active_bin", "get_top_candidates", "check_smart_wallets_on_pool", "get_token_holders", "get_token_narrative", "get_token_info", "search_pools", "get_pool_memory", "get_wallet_balance", "get_my_positions", "update_config", "set_active_strategy", "list_strategies", "get_hive_pulse", "get_hive_pool_consensus", "get_hive_lesson_consensus", "get_hive_pattern_consensus", "get_hive_threshold_consensus"]);
